package pimienta.julian.myfeelings
...
import pimienta.julian.myfeelings.utilities.CustomBarDrawable
import pimienta.julian.myfeelings.utilities.CustomCircleDrawable
import pimienta.julian.myfeelings.utilities.Emociones
import pimienta.julian.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun actualizarGrafica(){
        ...
        lista.clear ()
        lista.add (Emociones ("Muy feliz", pH, R.color. mustard, veryHappy))
